-- Las facturas ahora se generan de forma aleatoria (cualquier letra A-Z + 3 o mas digitos),
-- no solo con la letra A. Se amplia la validacion para aceptar el nuevo formato.
